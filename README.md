...
💬 Ask me about **.NET, Entity Framework Core, Angular, TypeScript, Microsoft SQL Server, NodeJs <br>React, JavaScript, Oracle, T-SQL, ASP.NET Core MVC/WEB API, Vue</br>**
